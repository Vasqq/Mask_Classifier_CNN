...
y_pred = net.predict(bias_dataset)
y_test = np.array([y for x, y in iter(bias_dataset)]) 
...
plot_confusion_matrix(net, bias_dataset, y_test.reshape(-1, 1),display_labels= classes)
plt.show()